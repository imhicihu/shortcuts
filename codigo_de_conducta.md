...
Instancias de comportamiento abusivo, acosador o inaceptable de otro modo podrán ser reportadas a los administradores de la comunidad responsables del cumplimiento a través de `imhicihu` en `gmail` punto `com`. Todas las quejas serán evaluadas e investigadas de una manera puntual y justa.
...
[P&iacutegina principal]: https://www.contributor-covenant.org
